<html>
<head>
<title>Gerenciar redirecionamentos</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para Adicionar redirecionamento utilize o campo abaixo:</p>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de redirecionamentos</b></td>';
