<html>
<head>
<title>Gerenciar Horário liberado</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Após editar o horário clique em Aplicar</p>";
...
echo '<table class="tabela">';
	...
	echo '<td class="opcao"><b>editar</b></td>';
	echo '<td><b>horario atual</b></td>';
...
echo $num;
echo ")'><img src='../includes/pencil.png' alt='Editar Regra' title='Editar horário'></img></a>";
echo '</td>';
