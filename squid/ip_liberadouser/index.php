<html>
<head>
<title>Gerenciar IPs liberados por usuario</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para Adicionar IPs liberados, utilize o campo abaixo:</p>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de IPs Liberados</b></td>';
