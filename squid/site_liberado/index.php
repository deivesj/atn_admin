<html>
<head>
<title>Gerenciar sites liberados</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para Adicionar site liberado utilize o campo abaixo:</p>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de dominios Liberados</b></td>';
