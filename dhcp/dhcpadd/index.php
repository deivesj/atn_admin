<html>
<head>
<title>Cadastrar MAC x IP</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para amarrar IP ao MAC, utilize o campo abaixo:</p>";
	echo "Mac: <input class='inputm' type='text' width='400' name='mac' /> ";
	echo "<br>";
	echo "Hostname: <input class='inputh' type='text' width='400' name='hostname' /> ";
	echo "<br>";	
	echo "IP: <input class='inputi' type='text' width='400' name='ip' /> ";
	echo "<br>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de IPs Amarrados ao MAC</b></td>';
...
echo $num;
echo ')" ><img src="../includes/styles/cross.png" alt="Apagar Regra" title="Apagar Regra"></img></a>';
echo "<a href='javascript:AbrePop(";
echo $num;
echo ")'><img src='../includes/styles/pencil.png' alt='Editar Regra' title='Editar Regra'></img></a>";
echo '</td>';
