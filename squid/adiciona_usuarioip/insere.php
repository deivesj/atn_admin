<html>
<head>
<title>Inserindo novo usuário liberado por ip</title>
<body bgcolor="#FFFFFF">
<center>
<br>
<br>
<font size="5" face="Tahoma"><b>Aguarde, inserindo usuário liberado por ip</b>
<br>
<img src="../includes/load.gif" />

<?php
include_once('../includes/files.inc.php');
$arquivoTmp = "$liberadoporipuserTmp";	
$arquivo = "$liberadoporipuser";
