<html>
<head>
<title>Gerenciar IPs bloqueados</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para Adicionar IPs bloqueados, utilize o campo abaixo:</p>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de IPs bloqueados</b></td>';

//NOVO METODO PARA CONTAR    
$arquivo = "$ipsbloqueados";
