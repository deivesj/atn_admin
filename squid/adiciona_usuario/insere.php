<html>
<head>
<title>Inserindo novo usuário livre</title>
<body bgcolor="#FFFFFF">
<center>
<br>
<br>
<font size="5" face="Tahoma"><b>Aguarde, inserindo usuário liberado</b>
<br>
<img src="../includes/load.gif" />

<?php
include_once('../includes/files.inc.php');
$arquivoTmp = "$usersliberadosTmp";	
$arquivo = "$usersliberados";
