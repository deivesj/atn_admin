...
function Nmap() {
	window.open( "limpa_dhcpd.php", "Limpa Historico dhcp", "status = 1, height = 400, width = 300, resizable = 0, toolbar = no, menubar=no, location = no, left=50, top=100, resizable=yes, scrollbars=yes, directories=no, status=no")
}
</script>
<center>
<input class="botao" type='button' onClick='Ping()' value='Teste Ping'>
<input class="botao" type='button' onclick='Nmap()' value='limpa histórico dhcp'>
</center>
</td>
</tr>
</table>
